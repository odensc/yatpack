...
// export const pipeline = new gstreamer.Pipeline(`
// v4l2src device=/dev/video0 ! video/x-raw, width=1920, height=1080, framerate=60/1, format=YUY2 ! nvvidconv ! video/x-raw(memory:NVMM), format=NV12 ! \
//   nvv4l2h265enc name=enc maxperf-enable=1 bitrate=${Math.floor(
// 		stream.bitrate * 1000 * 1000
...
//   mpegtsmux alignment=7 name=mux ! srtserversink name=srt uri="srt://75.164.106.198:1935?streamid=input/live/cam" latency=300  \
